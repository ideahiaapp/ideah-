...
export const mockEvolutions = [
  {
    ...
    content: "Sessão marcada por silêncios longos e relatos de anestesia afetiva. A cliente trouxe lembrança da mãe pela terceira sessão consecutiva, dessa vez com tom mais raivoso do que triste. Relatou sonho em que tentava ligar para a mãe, mas o telefone não funcionava.",
