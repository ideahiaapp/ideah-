      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          ...
          <div className="bg-brand-500 rounded-2xl p-8 shadow-xl relative overflow-hidden">
            ...
            <p className="text-sm font-semibold text-white mb-2">Anual</p>
            <div className="flex items-end gap-1 mb-1">
              <span className="text-4xl font-bold text-white">R$ 39</span>
              <span className="text-2xl font-bold text-white">,92</span>
              <span className="text-white text-sm mb-1">/mês</span>
            </div>
            <p className="text-xs text-white mb-1">Cobrado anualmente · R$ 479,04/ano</p>
            <p className="text-xs text-white mb-6 line-through">R$ 598,80/ano</p>
            <ul className="space-y-3 mb-8">
