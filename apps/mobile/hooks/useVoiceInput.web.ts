...
/**
 * Versão web do hook de ditado por voz (rodando no Expo Web via react-native-web) —
 * usa a Web Speech API do navegador diretamente, mesma abordagem do app web.
 * A versão nativa (iOS/Android) fica em useVoiceInput.native.ts.
 */
